...
public class Tcarts_FPO extends Base {

	public static WebDriver driver = Base.initializeWebDriver("chrome");
	public static PageObjectManager pom = new PageObjectManager(driver);
	public static Logger log = Logger.getLogger(Tcarts_FPO.class);
	...
	public static void startTest() {
		...
		report = new ExtentReports("/home/st/eclipse-workspace/Tcarts/Report/ExtentReport/Report.html");
